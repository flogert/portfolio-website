...
const Footer = () => {
  return (
    <div className='bg-slate-200 dark:bg-slate-900 h-fit w-full flex md:flex-row xs:flex-row flex-col justify-center gap-20 items-center'>
      <div className='flex md:flex-row xs:flex-row flex-col text-center p-2'>
        <ul>
      ...
      <p className='text-xs text-gray-800 dark:text-gray-200 mt-2 cursor-default'>&copy; {new Date().getFullYear()} Flogert Bardhi</p>
